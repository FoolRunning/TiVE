...
namespace ProdigalSoftware.TiVE.Renderer.Voxels
{
    ...
    {
        private static readonly VoxelMeshHelper shadedNonInstanced = new ShadedVoxelMeshHelper(false);
        private static readonly VoxelMeshHelper shadedInstanced = new ShadedVoxelMeshHelper(true);
        ...
        /// </summary>
        public static VoxelMeshHelper Get(bool drawShaded, bool forInstances)
        {
            if (drawShaded)
        ...
        #region ShadedVoxelMeshHelper class
        private sealed class ShadedVoxelMeshHelper : VoxelMeshHelper
        {
            private const int SmallColorDiff = 7;
            private const int BigColorDiff = 14;

            private readonly bool forInstances;

            public ShadedVoxelMeshHelper(bool forInstances)
            {
                this.forInstances = forInstances;
            }

            public override string ShaderName
            {
                get { return forInstances ? "ShadedInstanced" : "ShadedNonInstanced"; }
            }
