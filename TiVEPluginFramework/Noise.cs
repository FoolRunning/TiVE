namespace ProdigalSoftware.TiVEPluginFramework
{
    ...
    /// The code was taken from <see cref="http://cabbynode.net/2012/06/10/perlin-simplex-noise-for-c-and-xna/"/> which was ported from
    /// a paper “Simplex noise demystified”, by Stefan Gustavson, Linköping University (2005)
    /// </summary>
    public static class Noise
    {
        ...
        public static float GetNoise(double pX)
        {
            return GetNoise(pX, 0.0, 0.0);
        }

        public static float GetNoise(double pX, double pY)
        {
            return GetNoise(pX, pY, 0.0);
        }
