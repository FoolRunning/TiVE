...
{
    /// <summary>
    /// A speed-improved simplex noise algorithm for 2D, 3D in C# (from original Java code).
    /// 
    ...
    /// </summary>
    /// <remarks>The code is a port of the code at <see cref="http://webstaff.itn.liu.se/~stegu/simplexnoise"/></remarks>
